...
nonhispanic.url <- "X:/DSA/shiny-uploads/trends/seashore-sep21/data/workers-by-race-quarter.xlsx"
hispanic.url <- "X:/DSA/shiny-uploads/trends/seashore-sep21/data/workers-by-hispanic-origin-race.xlsx"

sales.url <- "X:/DSA/shiny-uploads/trends/seashore-sep21/data/TaxableRetailSales.xlsx"

homesales.url <- "X:/DSA/shiny-uploads/trends/seashore-sep21/data/HomeSalesRedfin.xlsx"
rentals.url <- "X:/DSA/shiny-uploads/trends/seashore-sep21/data/Metro_ZORI_AllHomesPlusMultifamily_SSA.csv"

ntd.url <- "X:/DSA/shiny-uploads/trends/seashore-sep21/data/NTD-Raw-Database.xlsx"
volume_file <- "X:/DSA/shiny-uploads/trends/seashore-sep21/data/VolumeNumTableCountLocation_data.csv"
truck_file <- "X:/DSA/shiny-uploads/trends/seashore-sep21/data/Freight_Table_data.csv"
ferry_file <- "X:/DSA/shiny-uploads/trends/seashore-sep21/data/FerriesTable_data.csv"
...
tax.19 <- sales.tax %>% filter(Quarter =="2019-01-01", Tax.Type == "Sales") %>% rename(Q12019=Total.Taxable) %>% select("Geography","Q12019")
tax.20 <- sales.tax %>% filter(Quarter =="2020-01-01", Tax.Type == "Sales") %>% rename(Q12020=Total.Taxable) %>% select("Geography","Q12020")
tax.21 <- sales.tax %>% filter(Quarter =="2021-01-01", Tax.Type == "Sales") %>% rename(Q12021=Total.Taxable) %>% select("Geography","Q12021")
